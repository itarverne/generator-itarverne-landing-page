...
module.exports = class extends Generator {
	...
	writing() {
		...
		this.fs.copyTpl(
			this.templatePath(this.props.template + '/index.html'),
		...
		this.fs.copyTpl(
			this.templatePath(this.props.template + '/cookies.html'),
		...
		this.fs.copyTpl(
			this.templatePath(this.props.template + '/scripts/react/main-react.jsx'),
