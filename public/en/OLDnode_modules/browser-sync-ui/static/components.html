...
<body>
    <main>
        ...
        <div class="tube">
            ...
            <div>
                <button bs-button="icon-left"><svg bs-svg-icon=""><use xlink:href="#svg-square-add"/></svg> Icon Left</button>
                <button bs-button="icon-right"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg> Icon Right</button>
                <button bs-button="icon"><svg bs-svg-icon=""><use xlink:href="#svg-target"/></svg></button>
                <button bs-button="icon" disabled><svg bs-svg-icon=""><use xlink:href="#svg-target"/></svg></button>
            </div>
            <div>
                <button bs-button="size-small icon-left"><svg bs-svg-icon=""><use xlink:href="#svg-square-add"/></svg> Icon Left</button>
                <button bs-button="size-small icon-right"><svg bs-svg-icon=""><use xlink:href="#svg-bug"/></svg> Icon Right</button>
                <button bs-button="size-small icon"><svg bs-svg-icon=""><use xlink:href="#svg-target"/></svg></button>
                <button bs-button="size-small icon" disabled><svg bs-svg-icon=""><use xlink:href="#svg-target"/></svg></button>
            </div>
            <br>
            <p>Subtle buttons with icons</p>
            <div>
                <button bs-button="subtle icon-left"><svg bs-svg-icon=""><use xlink:href="#svg-square-add"/></svg> Icon Left</button>
                <button bs-button="subtle icon-right"><svg bs-svg-icon=""><use xlink:href="#svg-bug"/></svg> Icon Right</button>
                <button bs-button="subtle icon"><svg bs-svg-icon=""><use xlink:href="#svg-target"/></svg></button>
                <button bs-button="subtle icon" disabled><svg bs-svg-icon=""><use xlink:href="#svg-help"/></svg></button>
            </div>
            <div>
                <button bs-button="size-small subtle icon-left"><svg bs-svg-icon=""><use xlink:href="#svg-square-add"/></svg> Icon Left</button>
                <button bs-button="size-small subtle icon-right"><svg bs-svg-icon=""><use xlink:href="#svg-bug"/></svg> Icon Right</button>
                <button bs-button="size-small subtle icon"><svg bs-svg-icon=""><use xlink:href="#svg-target"/></svg></button>
                <button bs-button="size-small subtle icon" disabled><svg bs-svg-icon=""><use xlink:href="#svg-help"/></svg></button>
            </div>
            <br>
            <p>Alternative Subtle button styles with icons</p>
            <div>
                <button bs-button="size-small subtle-alt icon-left"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg> Icon Left</button>
                <button bs-button="size-small subtle-alt icon-right"><svg bs-svg-icon=""><use xlink:href="#svg-bug"/></svg> Icon Right</button>
                <button bs-button="size-small subtle-alt icon"><svg bs-svg-icon=""><use xlink:href="#svg-target"/></svg></button>
                <button bs-button="size-small subtle-alt icon" disabled><svg bs-svg-icon=""><use xlink:href="#svg-help"/></svg></button>
            </div>
        ...
        <div class="tube">
            <h1>Button bars</h1>
            <div bs-button-group>
                <button bs-button="icon-left"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg> Website</button>
                <button bs-button="icon-left"><svg bs-svg-icon=""><use xlink:href="#svg-twitter"/></svg> Twitter</button>
                <button bs-button="icon-right"><svg bs-svg-icon=""><use xlink:href="#svg-github"/></svg> Github</button>
                <button bs-button="icon" disabled><svg bs-svg-icon=""><use xlink:href="#svg-target"/></svg></button>
            </div>
            <div bs-button-group>
                <button bs-button="icon"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg></button>
                <button bs-button="icon"><svg bs-svg-icon=""><use xlink:href="#svg-twitter"/></svg></button>
                <button bs-button="icon"><svg bs-svg-icon=""><use xlink:href="#svg-github"/></svg></button>
                <button bs-button="icon"><svg bs-svg-icon=""><use xlink:href="#svg-target"/></svg></button>
            </div>
            <div bs-button-group>
                <button bs-button>Button</button>
                <button bs-button="icon"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg></button>
                <button bs-button="icon-left"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg> Button Small</button>
                <button bs-button disabled>n/a</button>
                <button bs-button="icon-right"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg> Button Small</button>
            </div>
            <div bs-button-group>
                <button bs-button="subtle-alt">Button</button>
                <button bs-button="subtle-alt icon"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg></button>
                <button bs-button="subtle-alt icon-left"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg> Button Small</button>
                <button bs-button="subtle-alt" disabled>n/a</button>
                <button bs-button="subtle-alt icon-right"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg> Button Small</button>
            </div>
            <div bs-button-group>
                <button bs-button="size-small subtle-alt">Button</button>
                <button bs-button="size-small subtle-alt icon"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg></button>
                <button bs-button="size-small subtle-alt icon-left"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg> Button Small</button>
                <button bs-button="size-small subtle-alt" disabled>n/a</button>
                <button bs-button="size-small subtle-alt icon-right"><svg bs-svg-icon=""><use xlink:href="#svg-globe"/></svg> Button Small</button>
            </div>
            </div>
        <hr>
        <div class="tube">
            ...
            <div bs-input="text">
                ...
                <div bs-input-group>
                    ...
                    <button bs-button="subtle-alt icon"><svg bs-svg-icon=""><use xlink:href="#svg-circle-plus"/></svg></button>
                </div>
            </div>
            ...
            <div bs-input="text">
                ...
                <div bs-state-wrapper ng-class="[ctrl.state.classname]">
                    <button type="submit" id="add-restriction" bs-button="size-small subtle-alt icon-left" ng-disabled="ctrl.state.waiting">
                        <svg bs-svg-icon="" icon="circle-plus"><use xlink:href="#svg-circle-plus"/></svg>Add</button>
                    <div bs-state-icons>
                        <svg bs-svg-icon="" icon="circle-ok" bs-state="success inline"><use xlink:href="#svg-circle-ok"/></svg>
                        <svg bs-svg-icon="" icon="circle-minus" bs-state="waiting inline" bs-anim="spin"><use xlink:href="#svg-circle-minus"/></svg>
                    </div>
                </div>
            </div>
                ...
                <li>
                    ...
                    <div bs-button-group>
                        <button href="#" bs-button="subtle-alt icon">
                          <svg bs-svg-icon=""><use xlink:href="#svg-syncall"/></svg>
                        </button>
                        <button href="#" bs-button="subtle-alt icon">
                            <svg bs-svg-icon=""><use xlink:href="#svg-bin"/></svg>
                        </button>
                    </div>
                </li>
                <li>
            ...
            <hr>
                ...
                <div bs-button-row>
                    <button bs-button="inline icon-left success" ng-click="setMany(true)">
                        <svg bs-svg-icon=""><use xlink:href="#svg-circle-ok"/></svg>
                        Enable All
                    </button>
                    <button bs-button="icon-left inline" ng-click="setMany(false)">
                        <svg bs-svg-icon=""><use xlink:href="#svg-circle-delete"/></svg>
                        Disable all
                    </button>
                </div>
            </div>
            ...
            <header bs-header role="banner">
                <div bs-header-row="brand">
                    ...
                    <span bs-toggle="nav" ng-click="app.toggleMenu('shane')" ng-class="{'active': app.ui.sectionMenu}">
                        <svg>
                            <use xlink:href="#svg-list"/>
                        </svg>
                        <svg bs-state="alt">
                            <use xlink:href="#svg-circle-delete"/>
                        </svg>
                    </span>
                </div>
                <aside bs-controls="top">
                    <div bs-flex="top">
                        <a href="#" bs-control title="Reload all Browsers" ng-click="app.reloadAll()">
                            <svg bs-svg-icon=""><use xlink:href="#svg-repeat"/></svg>
                            Reload all
                        </a>
