...
<div id="results1" class="results">
	<div class="intro">
		<p>To see callbacks being logged, <strong>open your browser's console</strong>.</p>
		<p>In case of error, the image is set to a fallback image generated by <a href="http://placehold.it">placehold.it</a></p>
	</div>
	<ul>
		<li>
			<a href="#/it/donna/stivaletti_cod44721746jj.html">
				<picture>
					<source media="(min-width: 1024px)" srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img alt="Stivaletti" src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
			<a href="#/it/donna/open-toe_cod44740806jx.html">
				<picture>
					<source media="(min-width: 1024px)" data-srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" data-srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img alt="Open toe" data-src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
			<a href="#/it/donna/sneakers-tennis-shoes-basse_cod44735977gr.html">
				<picture>
					<source media="(min-width: 1024px)" data-srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" data-srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img alt="Sneakers &amp; Tennis" data-src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
			<a href="#/it/donna/sneakers-tennis-shoes-basse_cod44738717am.html">
				<picture>
					<source media="(min-width: 1024px)" data-srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" data-srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img alt="Sneakers &amp; Tennis shoes basse" data-src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
			<a href="#/it/donna/sneakers-tennis-shoes-alte_cod44739940cb.html">
				<picture>
					<source media="(min-width: 1024px)" data-srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" data-srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img class="lazy" alt="Sneakers &amp; Tennis shoes alte" data-src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
		...
		<li>
			<a href="#/it/donna/sneakers-tennis-shoes-basse_cod44738719vn.html">
				<picture>
					<source media="(min-width: 1024px)" data-srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" data-srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img class="lazy" alt="Sneakers &amp; Tennis shoes basse" data-src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
		...
		<li>
			<a href="#/it/donna/stivali_cod44736534fq.html">
				<picture>
					<source media="(min-width: 1024px)" data-srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" data-srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img class="lazy" alt="Stivali" data-src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
		...
		<li>
			<a href="#/it/donna/stivaletti_cod44739165ev.html">
				<picture>
					<source media="(min-width: 1024px)" data-srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" data-srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img class="lazy" alt="Stivaletti" data-src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
		...
		<li>
			<a href="#/it/donna/decollete_cod44721899ng.html">
				<picture>
					<source media="(min-width: 1024px)" data-srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" data-srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img class="lazy" alt="Décolleté" data-src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
			<a href="#/it/donna/mocassini_cod44721744sl.html">
				<picture>
					<source media="(min-width: 1024px)" data-srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" data-srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img class="lazy" alt="Mocassini" data-src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
		...
		<li>
			<a href="#/it/donna/francesine_cod44717679mj.html">
				<picture>
					<source media="(min-width: 1024px)" data-srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" data-srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img class="lazy" alt="Francesine" data-src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
		...
		<li>
			<a href="#/it/donna/cuissardes_cod44729472iq.html">
				<picture>
					<source media="(min-width: 1024px)" data-srcset="http://placehold.it/220x280 1x, http://placehold.it/440x560 2x">
					<source media="(min-width: 500px)" data-srcset="http://placehold.it/330x420 1x, http://placehold.it/660x840 2x">
					<img class="lazy" alt="Cuissardes" data-src="http://placehold.it/220x280">
				</picture>
			</a>
		</li>
		<li>
...
<script>
	(function () {
		...
		ll = new LazyLoad({
			...
			callback_processed: function (element) {
				logElementEvent("PROCESSED", element);
			},
