...
</p><p>Both the <b>Debug Client</b> and the <b>Debug Target</b> communicate to
the <b>Debug Server</b> via HTTP using <tt>XMLHttpRequest</tt> (XHR).

</p><p>Typically, you run both the <b>Debug Client</b> and the <b>Debug Server</b>
on your desktop/laptop, and the <b>Debug Target</b> on your mobile device.

</p><p>The <b>Debug Target</b> is the squirrelliest bit.  You
...
<!-- ======================================================== -->
</p><h2>Running the debug server using an <tt>npm</tt> installation</h2>
...
</p><p>The server will run until you kill it.  Control-C will do the job.

</p><p>Options available are:
...
</li><li><tt>--httpPort [portNumber]</tt>
<div class="indent">
<p>The port to run the HTTP server on.
</p><p>Default: <tt>8080</tt>
</p></div>

</li><li><tt>--boundHost [hostname | ip address | -all-]</tt>
<div class="indent">
<p>The ip address to bind the server to.
</p><p>Default: <tt>localhost</tt>

</p><p>With the default of <tt>localhost</tt>, you won't be able to access
...
</li><li><tt>--deathTimeout [seconds]</tt>
<div class="indent">
<p>The number of seconds to wait to hear back from a
debug client or target before declaring them dead.
</p><p>Default: <tt>3 * readTimeout</tt>

</p><p>Normally the default will be fine.  However, if
...
<!-- ======================================================== -->
</p><h2>The <tt>~/.weinre/server.properties</tt> file</h2>
...
</p><p>The keys should be
the same as the name of the options above,
with the same values.

</p><p>As an example, your <tt>~/.weinre/server.properties</tt>
...
</p><p>Command-line options override the options specified in the
<tt>~/.weinre/server.properties</tt> file.

<!-- ======================================================== -->
</p><h2>Running the debug server bound to something other than <tt>localhost</tt>
...
</p><p>To get started, you can use the value <tt>-all-</tt> for the
<tt>--boundHost</tt> option.

</p><p>Now you'll need to figure out what host name / ip address the
...
</p><p>From the debug target device (eg, your mobile device),
...
<!-- ======================================================== -->
</p><h2>Instrumenting your web page to act as a debug target
...
</p><p>To make your web page debuggable with <span class="weinre">weinre</span>,
add the following line to your web page:
<pre>
&lt;script src="http://a.b.c:8081/target/target-script-min.js"&gt;&lt;/script&gt;
</pre>

</p><p>You can now open a debug client by browsing to
...
<!-- ======================================================== -->
</p><h2>Hardcoding host names / IP addresses in your web page?

<p>Yeah, gross.

</p><p>Besides being gross, there are a few practical problems with hardcoding the
...
</p><p>If you use one of these dynamic DNS services, you
...
</p><p>Unfortunately, installing bookmarkets on mobile devices isn't usually trivial.  The easiest
...
</p><p>Once the bookmarklet is installed, you can debug any web page
