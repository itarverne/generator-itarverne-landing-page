...
</p><p>There is no password, just an id.  There is no real security here.
...
</p><p>So don't give your <b>id</b> to anyone else that you don't want to share
with.

</p><p>To keep your <b>id</b>'s familar but non-guessable, you might use a string
consisting of your typical userid, followed by a dash, followed by another
string not likely to be guessed by other people.

</p><p>If you are paranoid, you can change your <b>id</b> every time you start
a debug session, of course.

<!-- ======================================================== -->
</p><h2>Using your id with the client</h2>
...
</p><p>The id which is used will be displayed
in the connected clients list for each connected client.

<!-- ======================================================== -->
</p><h2>Using your id with the target</h2>
...
</p><p>use this script element to connect with id <code>itsReallyMe</code>
...
</li><li>The <b>id</b> is passed in the HTTP body of a POST request during the
...
</li><li>There is no programmatic interface in <span class="weinre">weinre</span>
