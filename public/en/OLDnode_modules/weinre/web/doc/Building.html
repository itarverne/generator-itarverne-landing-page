...
</p><p>If you'd prefer to obtain the source via git, you can use one of the
following repos:
...
</p><p>The Apache repo is the canonical repo. The url can be used in a web
browser, or as the argument of a <tt>git clone</tt> command.

</p><p>The GitHub repo is a clone of the Apache repo, and automatically shadowed
at some regular interval.  The url is the web view of the repo, from
which you can obtain a url to use with <tt>git clone</tt>.

</p><p>See the file
<tt><a href="https://git-wip-us.apache.org/repos/asf?p=cordova-weinre.git;a=blob;f=README.md;hb=HEAD">README.md<a></a></a></tt>
