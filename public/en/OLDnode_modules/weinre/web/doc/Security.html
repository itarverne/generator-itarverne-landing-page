...
</p><p>Obviously there should be some.  The question is, what do we need to do?

<!-- ======================================================== -->
</p><h2>Background and potential exposures</h2>
...
</p><p>The primary security exposure with <span class="weinre">weinre</span> is via
the debug server.

</p><p>Currently, the server only reads files from the weinre-node distribution,
...
</p><p>If you use the default <tt>--boundHost</tt> option value of
...
</p><p>If you use a non-default <tt>--boundHost</tt> option value,
...
</p><p>The most obvious exposure with using <tt>--boundHost</tt> and
...
</p><p>Other exposures include leaving a debug target injection
...
<!-- ======================================================== -->
</p><h2>Future Implementation Ideas</h2>
