...
<!-- ======================================================================= -->
</p><h2>the server home page</h2>

<p><img src="../../../../../images/server-home.png">

</p><p>The server home page is accessed at the root URL of the server, in this case
<tt>http://localhost:8081/</tt>.

<table><tr><td><img src="../../../../../images/circled-a.png">
</td><td>This link will launch the
...
</p><p><table><tr><td><img src="../../../../../images/circled-b.png">
</td><td>This is the URL of the script that you add to your
web page to allow it to be debugged by the client.
</td></tr></table>

</p><p>Additional links shown in this image are for this documentation, and some demo
pages.

</p><p>Further down on the page, not shown in the image, are:

<ul>
<li>The text of the <tt>&lt;script src=&gt;</tt> element you can copy and paste into your
web page.
</li><li>The source for a bookmarklet, to inject the debug code into any web
page displayed in your browser.
</li><li>Version numbers of <span class="weinre">weinre</span> and it's components.
</li></ul>

<!-- ======================================================================= -->
</p><h2>the Remote panel</h2>

<p><img src="../../../../../images/panel-remote.png">

</p><p>The Remote panel is the initial panel of <span class="weinre">weinre</span>,
and displays some status regarding the server.

<table><tr><td><img src="../../../../../images/circled-a.png">
</td><td>The top portion of all of the
...
</td><td>The Targets section of this page lists targets that are currently connected
...
</p><p><table><tr><td><img src="../../../../../images/circled-c.png">
</td><td>The Clients section of this page lists the clients that are currently connected
to the server.  A client is this user interface. Typically, there is just one - the client you are displaying
at the time.
</td></tr></table>

</p><p><table><tr><td><img src="../../../../../images/circled-d.png">
</td><td>The Server Properties section of this page displays the values of various server
...
</p><p>The colors of the entries in the Targets and Clients list indicates their
...
</p><p>In case there are multiple targets connected, you can switch which one you
are debugging by clicking on the item.

<!-- ======================================================================= -->
</p><h2>the Elements panel</h2>

<p><img src="../../../../../images/panel-elements.png">

</p><p>The Elements panel displays your HTML DOM in a tree fashion, and properties
associated with selected elements.

<table><tr><td><img src="../../../../../images/circled-a.png">
</td><td>The elements themselves may be expanded/collapsed via the disclosure buttons.
...
</td><td>The sidebar area displays information about the selected element.  In this case,
...
<!-- ======================================================================= -->
</p><h2>the Resources panel</h2>

<p><img src="../../../../../images/panel-resources.png">

</p><p>The Resources panel shows WebSQL databases, and data stored in Local Storage
and Session Storage.

<table><tr><td><img src="../../../../../images/circled-a.png">
</td><td>The left hand side of the Resources panel is the navigator. Expanding
...
</td><td>The right hand side is the editor/viewer for whatever is selected in the
navigator pane.
...
</td><td>The reload button will refresh the data from the target.
</td></tr></table>

<!-- ======================================================================= -->
</p><h2>the Network panel</h2>

<p><img src="../../../../../images/panel-network.png">

</p><p>The Network panel shows you information regarding XHR requests that you've
made.

<table><tr><td><img src="../../../../../images/circled-a.png">
</td><td>Each XHR will be shown in a separate row in the table.  Clicking the
...
</td><td>The "dots and lines" button can be used to change the table layout to
show less information in a more compact format.
</td></tr></table>

</p><p><table><tr><td><img src="../../../../../images/circled-c.png">
</td><td>The "not" button will clear the entries from the table.
</td></tr></table>

<!-- ======================================================================= -->
</p><h2>the Timeline panel</h2>

<p><img src="../../../../../images/panel-timeline.png">

</p><p>The Timeline panel is used to show events that are occurring in the target.
...
</p><p>Note that timing events are not collected unless you enable the "record"
button (see below).

<table><tr><td><img src="../../../../../images/circled-a.png">
</td><td>The left hand pane of the Timeline panel shows the events that have occurred.
Hovering over an entry will show additional detail about the event.
</td></tr></table>

</p><p><table><tr><td><img src="../../../../../images/circled-b.png">
</td><td>The right hand pane of the Timeline panel shows the events as they occurred
...
</td><td>The "dots and lines" button can be used to show and hide events that last
less than a fixed time (currently 15ms).
</td></tr></table>

</p><p><table><tr><td><img src="../../../../../images/circled-d.png">
</td><td>The "record" button is used to start or stop event collection.  When
...
</p><p><table><tr><td><img src="../../../../../images/circled-e.png">
</td><td>The "not" button will clear the current timing entries.
</td></tr></table>


<!-- ======================================================================= -->
</p><h2>the Console panel</h2>

<p><img src="../../../../../images/panel-console.png">

</p><p>The Console panel is used to execute arbitrary JavaScript expressions/statements.  It
also shows the output from various <tt>console</tt> methods, like
<tt>console.log()</tt>.

</p><p>In the example above, the JavaScript statements entered by the user are in
blue, the output of the statements is just below it, and messages generated by
<tt>console.log()</tt> are in black.

<table><tr><td><img src="../../../../../images/circled-a.png">
</td><td>The "not" button will clear the console.
</td></tr></table>

</p><p><img src="../../../../../images/panel-remote-console.png">

</p><p>The Console can also be embedded in every panel, by clicking the "console"
button.

<table><tr><td><img src="../../../../../images/circled-a.png">
</td><td>The "console" button will embed the console in the bottom half of the
